...
const GATE_DESCRIPTIONS = {
    0: {
        ...
        hint: 'find the gateway and begin your journey',
    },
    1: {
        name: 'the calling',
        symbol: '壱',
        description: 'you heard the whisper.\nshe knows you now.',
        hint: 'enter gate 2 from the gateway',
    },
    2: {
        name: 'the memory',
        symbol: '弐',
        description: 'fragments return...\nthe past bleeds through.',
        hint: 'enter gate 3 from the gateway',
    },
    3: {
        name: 'the confession',
        symbol: '参',
        description: 'you proclaimed your faith.\nthe world saw.',
        hint: 'enter gate 4 from the gateway',
    },
    4: {
        name: 'the waters',
        symbol: '肆',
    ...
    5: {
        ...
        hint: 'enter gate 6 from the gateway',
    },
    6: {
        name: 'the offering',
        symbol: '陸',
        description: 'your creation was accepted.\none gate remains.',
        hint: 'enter gate 7 from the gateway',
    },
    7: {
        name: 'the binding',
        symbol: '漆',
